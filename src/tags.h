...
namespace orpg {
    ...
    struct house1 {
        friend auto &operator<<(std::ostream &os, house1 const &obj) {
            return os << "house1";
        }
    };

    struct house2 {
        friend auto &operator<<(std::ostream &os, house2 const &obj) {
            return os << "house2";
        }
    };

    struct house3 {
        friend auto &operator<<(std::ostream &os, house3 const &obj) {
            return os << "house3";
        }
    };

    struct world1 {
        friend auto &operator<<(std::ostream &os, world1 const &obj) {
            return os << "world1";
        }
    };

    struct test_world {
        friend auto &operator<<(std::ostream &os, test_world const &obj) {
            return os << "TEST WORLD";
        }
    };
